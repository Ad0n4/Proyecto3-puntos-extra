...
module tb_system_top_direct;
    ...
    task automatic apply_operation(
        ...
        input logic [4:0] divisor,
        input logic [6:0] exp_quotient,
        input logic [4:0] exp_remainder,
    ...
    initial begin
        ...
        // 127 / 31 = q 4, r 3
        select_i = 1'b0;
        apply_operation(7'd127, 5'd31, 7'd4, 5'd3, 1'b0);

        // 127 / 1 = q 127, r 0
        apply_operation(7'd127, 5'd1, 7'd127, 5'd0, 1'b0);

        // 100 / 30 = q 3, r 10
        apply_operation(7'd100, 5'd30, 7'd3, 5'd10, 1'b0);

        // 31 / 31 = q 1, r 0
        apply_operation(7'd31, 5'd31, 7'd1, 5'd0, 1'b0);

        apply_operation(7'd64, 5'd30, 7'd2, 5'd4, 1'b0);
        apply_operation(7'd90, 5'd30, 7'd3, 5'd0, 1'b0);
        apply_operation(7'd120, 5'd30, 7'd4, 5'd0, 1'b0);
